...
func TestValidateBridgePayloadAcceptsCompletedUnqualifiedCodexReceipt(t *testing.T) {
	...
	payload = bytes.Replace(payload, []byte(`"model_evidence":"turn.completed.resolved_model"`), []byte(`"model_evidence":""`), 1)
