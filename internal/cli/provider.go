...
func newProviderCmd() *cobra.Command {
	...
	cmd.AddCommand(newProviderPrimaryComparisonCmd(), newProviderAcceptanceCmd(), newProviderCampaignCmd(), newProviderMigrateCmd(), newProviderReadinessCmd(), newProviderEvidenceCmd(), newProviderScanReviewCmd())
	return cmd
}
